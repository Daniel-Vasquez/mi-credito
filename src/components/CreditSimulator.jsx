...
import Btn from "./Btn";
import "../components/styles/CreditSimulator.css";
...
const PERCENTAGE_ANNUAL_RATE = 8.9;
...
function CreditSimulator() {
  ...
  return (
    <div className="CreditSimulatorContainer">
      <h2 className="CreditSimulatorContainer_text">SIMULADOR DE CRÉDITO</h2>
      <div className="form_line"></div>
      <div>
        <div className="CreditSimulatorContainer_amount">
          <p>{formatMoney(desiredAmount)}</p>
          <p>Monto deseado</p>
        </div>
        <div className="CreditSimulatorContainer_amount-range">
          <input
            type="range"
      ...
      <div>
        <div className="CreditSimulatorContainer_rate">
          <p>{annualRate}%</p>
          <p>Tasa anual</p>
        </div>
        <div className="CreditSimulatorContainer_rate-range">
          <input
            type="range"
            min={MIN_ANNUAL_RATE}
            max={MAX_ANNUAL_RATE}
      ...
      <div className="CreditSimulatorContainer_term">
        <p className="CreditSimulatorContainer_term-text">Plazo a meses</p>
        <div className="CreditSimulatorContainer_term-btn">

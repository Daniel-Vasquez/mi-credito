...
function App() {
  return (
    <main className='MainContainer'>
      <img className='MainContainer_img'src={imgMain} alt="Background" loading="lazy"/>
      <img className='MainContainer_img-footer'src={imgFooter} alt="Background" loading="lazy"/>
      <Navbar/>
      <Header/>
      <FeaturesDesigned/>
      <EasyApi/>
